...
// Playlists Songs
const playlistsActivities = require('./api/playlistsActivities');
...
const PlaylistsVerifyService = require('./services/postgres/PlaylistsVerifyService');
...
const init = async () => {
  ...
  const playlistsVerifyService = new PlaylistsVerifyService();
